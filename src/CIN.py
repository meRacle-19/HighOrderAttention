...
__all__ = ["CompressedInteractionNetworkModel"]


class CompressedInteractionNetworkModel(ExtremeDeepFMModel):
    """define Factorization-Machine based Neural Network Model"""
    ...
    def _build_graph(self, hparams):
        ...
        with tf.variable_scope("exDeepFm") as scope:
            ...
            logit = self._build_extreme_FM(hparams, self.embed_out,
