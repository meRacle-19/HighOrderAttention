...
TRAIN_IMPRESSION_ID = CACHE_DIR + 'train_impressionId.csv'
EVAL_IMPRESSION_ID = CACHE_DIR + 'eval_impressionId.csv'
TEST_IMPRESSION_ID = CACHE_DIR + 'test_impressionId.csv'
INFER_IMPRESSION_ID = CACHE_DIR + 'infer_impressionId.csv'
